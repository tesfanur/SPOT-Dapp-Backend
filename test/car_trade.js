...
var carTradeContract;

contract('CarTrade', function(accounts) {
  var carInstance;
  it("CarTrade should access CarTrade contract", function(done) {
  //  console.log("publicKey",publicKey); //use this module to create public keys for assets
     CarTrade.deployed().then(function(carTradeContractPromise) {
        carTradeContract=carTradeContractPromise;
        ...
        return carTradeContract.getAllCarsDetailInfo();
      }).then(function(carInfo) {
        console.log("List of cars registerd on blockchain", carInfo);
      ...
      /**
      *Test list of cars already registed on blockchain
      */
